...
<template>
  ...
  >
    <section
      class="relative container py-16 lg:py-[150px] bg-[#fff] z-20 w-full bg-cover bg-center flex flex-col items-center"
    >
      <div
        ...
        >
          <div>
            <div class="mb-8 flex items-center justify-start">
              <img :src="feature.src" alt="Feature Icon" class="size-[20%]" />
            </div>
